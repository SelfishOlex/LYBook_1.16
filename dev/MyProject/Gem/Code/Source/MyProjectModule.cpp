...
namespace MyProject
{
    ...
    {
    public:
        AZ_RTTI(MyProjectModule, "{D42F0849-C3A8-4476-92BF-0D97340B067C}", AZ::Module);
...
AZ_DECLARE_MODULE_CLASS(MyProject_ebc264b367f841b6840b65ec4bd91a29, MyProject::MyProjectModule)
